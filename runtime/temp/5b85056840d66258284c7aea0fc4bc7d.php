<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/remittance.html";i:1554712287;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="ibox float-e-margins">
		...
		<div class="navbar navbar-default">                    
                <form id="search-form2" class="navbar-form form-inline"  method="get" action="<?php echo url('User/remittance'); ?>">
                ...
                <!--   <label for="input-order-id" class="control-label">收款账号:</label>                
                  <div class="input-group">
                    <input type="text" class="form-control" id="input-order-id" placeholder="收款账号" value="<?php echo \think\Request::instance()->param('account_bank'); ?>" name="account_bank" />                    
                  </div>
                  <label for="input-order-id" class="control-label">收款账户名:</label>                
                  <div class="input-group">
                    <input type="text" class="form-control" id="input-order-id" placeholder="收款账户名" value="<?php echo \think\Request::instance()->param('account_name'); ?>" name="account_name" />                    
                  </div> -->
                   ...
                   <div class="input-group margin">                    
                    <div class="input-group-addon">
                       ...
                       <input type="text" id="start_time" value="<?php echo \think\Request::instance()->param('create_time'); ?>" name="create_time" class="form-control pull-right">
                  </div>                  
                </div>
                <div class="form-group">    
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    <td class="text-left">
                                        <a href="<?php echo url('User/editWithdrawals',array('id'=>$v['id'])); ?>"><?php echo $v['id']; ?></a>
                                    </td> 
                                    <td class="text-left">
                                        <a href="<?php echo url('user/detail',array('id'=>$v['user_id'])); ?>">
                                             <?php echo $v['nickname']; ?>
                                        </a>
                                    </td>
                                    ...
                                    <td class="text-left"><?php echo $tx_status_arr[$v['status']]; ?></td>                                    
                                    ...
                                    <td class="text-left"><?php echo $v['remark']; ?></td>
                                      <td align="center" class="handle">
                                          <div style="text-align: center; width: 170px; max-width:250px;">
                                                    <!--<a href="<?php echo url('transfer',array('selected'=>$v['id'],'atype'=>'online')); ?>" class="btn blue"><i class="fa fa-hand-o-right"></i>在线转账</a>-->
                                                    <?php if($v['status'] == 1): ?>
                                                        <a href="<?php echo url('transfer',array('selected'=>$v['id'],'atype'=>'hand')); ?>" class="btn blue"><i class="fa fa-hand-o-up"></i>手动转账</a>
                                                    <?php else: endif; ?>
		...
		$.ajax({
			...
			success: function(v){	
                            ...
                            if(v.hasOwnProperty('status') && (v.status == 1))
                               location.href='<?php echo url('User/withdrawals'); ?>';
                            else                                
