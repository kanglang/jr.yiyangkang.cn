<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/pig/pigUserDestroy.html";i:1554712282;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3 class="panel-title"><i class="fa fa-list"></i>已销毁的鱼</h3>
                </div>
...
<script>
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/shop/pig/piginuserDestroy/p/"+page,//+tab,
