<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/supplier/supplier.html";i:1554712281;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
	             ...
	             <div class="box-header">
	               	<nav class="navbar navbar-default">	     
				        <div class="collapse navbar-collapse">
				          <form class="navbar-form form-inline" action="<?php echo U('supplier/index'); ?>" method="post">
				            <div class="form-group pull-right">
					            <a href="<?php echo U('supplier/supplier_info'); ?>" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加供应商</a>
				            </div>		          
				          </form>		
				      	</div>
	    			</nav>  
						...
						<tbody>
						  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
						  	<tr role="row" align="center">
								...
								<td><img width="20" height="20" src="__SHOP_URL__/images/<?php if($vo["is_check"] == 1): ?>yes.png<?php else: ?>cancel.png<?php endif; ?>" onclick="changeTableVal('suppliers','suppliers_id','<?php echo $vo['suppliers_id']; ?>','is_check',this)"/></td>
		                     <td>
		                      <a class="btn btn-primary" href="<?php echo U('supplier/supplier_info',array('suppliers_id'=>$vo['suppliers_id'])); ?>"><i class="fa fa-pencil"></i></a>
		                      <a class="btn btn-danger" href="javascript:void(0)" data-url="<?php echo U('supplier/supplierHandle'); ?>" data-id="<?php echo $vo['suppliers_id']; ?>" onclick="delfun(this)"><i class="fa fa-trash-o"></i></a>
							</td>
		                   </tr>
