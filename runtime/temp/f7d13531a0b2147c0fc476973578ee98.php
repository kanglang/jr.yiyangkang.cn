<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/order/delivery_list.html";i:1554712290;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"<?php echo url('order/ajaxdelivery'); ?>?p/"+page,//+tab,
