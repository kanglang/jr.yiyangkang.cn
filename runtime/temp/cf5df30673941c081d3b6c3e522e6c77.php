<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/www/wwwroot/pig.77cco.com/public/../application/shop/view/user/sendMessage.html";i:1554712286;s:67:"/www/wwwroot/pig.77cco.com/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="adderss-add">
    <div class="ner-reac ol_box_4" style="visibility: visible; position: fixed; z-index: 500; width: 100%; height:100%">
        <div class="box-ct">
            ...
            <form action="<?php echo U('shop/User/doSendMessage'); ?>" method="post" onSubmit="return checkForm()">
                <table width="90%" border="0" cellspacing="0" cellpadding="0">
                   ...
                   <tr style="height:60px">
                        ...
                        <td align="right" style="text-align: center;">
                            <button type="submit" class="btn btn-info "><span>发送</span></button>
                        </td>    
                    </tr>
                </table>
            </form>
