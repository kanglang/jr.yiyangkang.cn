<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/pig/piginuser.html";i:1554712282;}*/ ?>
                               ...
                               <!-- <td class="text-right">操作</td>  -->
                                ...
                                <?php if(is_array($userList) || $userList instanceof \think\Collection || $userList instanceof \think\Paginator): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                                    ...
                                    <!--     <td class="text-center">
                                        ...
                                        <td class="text-left"><?php if($list['is_able_sale'] == 1): ?><span style="color: red">成熟</span><?php elseif($list['is_able_sale']==0): ?><span style="color: blue">繁殖中</span><?php endif; ?></td>
                                        ...
                                        <td class="text-left"><?php if($list['checkstauts']==1): ?>正常<?php else: ?><span style="color:red;">异常</span><?php endif; ?></td>

                                        <td class="text-left">
                                          <a href="javascript:;" onclick="pigDel(<?php echo $list['id']; ?>)" class="btn btn-danger btn-xs">
