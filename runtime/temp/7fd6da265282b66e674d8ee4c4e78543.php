<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/order/order_log.html";i:1554712290;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
       		...
       		<div class="col-xs-12">
	           	...
	           	<div class="box-header">
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('Order/order_log'); ?>" id="search-form2" class="navbar-form form-inline" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="timegap" value="<?php echo (isset($timegap) && ($timegap !== '')?$timegap:''); ?>" placeholder="操作时间"  id="add_time" class="input-sm">
					                 </div>
                                </div>
                                <div class="form-group">
						...
						<tbody>
						  <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $k=>$vo): ?>
		                     ...
		                     <td><?php echo $vo['status_desc']; ?></td>
		                      <td><?php echo (isset($admin[$vo['action_user']]) && ($admin[$vo['action_user']] !== '')?$admin[$vo['action_user']]:'--'); ?></td>
