<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/systems/send_sms.html";i:1554712285;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
    ...
    <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
            ...
            <div class="row">
                <div class="col-sm-12">                                             
                    <form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('send_sms'); ?>">
                        <div class="col-sm-3">
                            <div class="input-group">
                                <input type="text" id="keyword" class="form-control" name="keyword" value="<?php echo $keyword; ?>" placeholder="请输入手机号码" />
                    ...
                    <table class="table table-bordered table-hover">
                        <thead>
                            <tr class="long-tr">
                                ...
                                <th width="6%">短信内容</th>
                                <th width="10%">发送场景</th>
                                <th width="8%">异常提示内容</th>
                            </tr>
                        </thead>

                        <?php if(is_array($smsList) || $smsList instanceof \think\Collection || $smsList instanceof \think\Paginator): $key = 0; $__LIST__ = $smsList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
                            <tr class="long-td">
                                <td><?php echo $key; ?></td>
                                <td><?php echo $vo['mobile']; ?></td>
                                <td><?php echo $vo['add_time']; ?></td>
                                <td><?php echo $vo['code']; ?></td>
                                <td><?php echo $vo['status_zn']; ?></td>
                                <td><?php echo $vo['msg']; ?></td>
                                <td><?php echo $vo['scene_zn']; ?></td>
                                <td><?php echo $vo['error_msg']; ?></td>
                            </tr>
                        <?php endforeach; endif; else: echo "" ;endif; ?>

                    </table>
                    <div class="page">
                        <?php echo $smsList->render(); ?>
                    </div>
                </div>
            </div>
        </div>
