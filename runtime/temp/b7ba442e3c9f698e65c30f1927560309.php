<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:85:"/www/wwwroot/jr.yiyangkang.cn/public/../application/admin/view/ad/index_position.html";i:1554712251;s:71:"/www/wwwroot/jr.yiyangkang.cn/application/admin/view/public/header.html";i:1554712249;s:45:"../application/common/view/public/header.html";i:1554712305;s:71:"/www/wwwroot/jr.yiyangkang.cn/application/admin/view/public/footer.html";i:1554712249;s:45:"../application/common/view/public/footer.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="row">
                ...
                <div  class="col-sm-2" style="width: 100px">
                    <div class="input-group" >  
                        <a href="<?php echo url('add_position'); ?>"><button class="btn btn-primary" type="button">添加广告位</button></a> 
                    </div>
                </div>                                                                    
                </div>
            </div>
                        ...
                        <tbody>
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$vo): ?>
                                <tr class="long-td">
                                    ...
                                    <td>
                                        <a href="<?php echo url('edit_position',['id'=>$vo['id']]); ?>" class="btn btn-primary btn-xs">
                                            <i class="fa fa-paste"></i> 编辑</a>&nbsp;&nbsp;
                                        <a href="javascript:;" onclick="del_position(<?php echo $vo['id']; ?>)" class="btn btn-danger btn-xs">
