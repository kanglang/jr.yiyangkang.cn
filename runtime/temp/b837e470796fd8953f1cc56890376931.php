<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/order/index.html";i:1554712290;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('shop/order/export_order'); ?>" id="search-form2" class="navbar-form form-inline" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="timegap" value="<?php echo (isset($timegap) && ($timegap !== '')?$timegap:''); ?>" placeholder="下单日期"  id="add_time" class="input-sm">
					                 </div>
                                </div>
                                <div class="form-group">
...
<script>
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/index.php/shop/order/ajaxindex/p/"+page,//+tab,
