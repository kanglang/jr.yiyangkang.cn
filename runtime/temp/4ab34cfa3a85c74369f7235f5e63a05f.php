<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/pickup/index.html";i:1554712292;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
				...
				<div class="ibox-content">
					<div class="navbar navbar-default">
						<form action="" id="search-form2" class="navbar-form form-inline" method="get" onsubmit="return false">
							...
							<button type="button" onclick="location.href='<?php echo U('Pickup/add'); ?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加自提点</button>
						</form>
					</div>
...
<script>
	...
	function ajax_get_table(form,page){
		...
		$.ajax({
			type : "POST",
			url:"<?php echo url('Pickup/ajaxPickupList'); ?>?p="+page,//+tab,
