<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:80:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/add_user.html";i:1554712287;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox-content">
                <form action="" method="post" onsubmit="return checkUserUpdate(this);">
                    ...
                    <tr>
                        <td>性别:</td>
                        <td id="order-status">
                            <input name="sex" type="radio" value="0" <?php if(!empty($user['sex']) && $user['sex'] == 0): ?>checked<?php endif; ?> >保密
                            <input name="sex" type="radio" value="1" <?php if(!empty($user['sex']) && $user['sex'] == 1): ?>checked<?php endif; ?> >男
                            <input name="sex" type="radio" value="2" <?php if(!empty($user['sex']) && $user['sex'] == 2): ?>checked<?php endif; ?> >女
                        </td>
                        <td></td>
                    </tr>
