<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/pig.77cco.com/public/../application/shop/view/user/editRecharge.html";i:1554712286;s:67:"/www/wwwroot/pig.77cco.com/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h3 class="panel-title"><i class="fa fa-list"></i> 审核支付状态</h3>
                </div>
                <div class="panel-body ">   
                    <!--表单数据-->
                    <form method="post" id="position" action="<?php echo U('shop/User/editRecharge'); ?>">                    
                        <!--通用信息-->
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>支付凭证：</td>
                                    <td>
                                        <img  width="300px" height="500px" src="<?php echo $data['img_url']; ?>">
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>审核状态：</td>
                                    <td>
                                        <select class="form-control m-b chosen-select" name="pay_status" id="pay_status">
                                            <option value="">==请审核支付状态==</option>
                                            <option <?php if(@$data['pay_status'] == 0): ?>selected<?php endif; ?> value="0">待审核</option>
                                            <option <?php if(@$data['pay_status'] == 1): ?>selected<?php endif; ?> value="1">审核成功</option>
                                            <option <?php if(@$data['pay_status'] == 2): ?>selected<?php endif; ?> value="2">审核失败</option>
                                        </select>
                                        <!-- <?php echo $data['pay_status']; ?> -->
                                        <td class="col-sm-4">审核会员支付状态</td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>备注：</td>
                                    <td>
                             			<textarea rows="5" cols="30" name="remark"><?php echo (isset($data['remark']) && ($data['remark'] !== '')?$data['remark']:''); ?></textarea>
                                    </td>
                                ...
                                <tfoot>
                                	<tr>
                                	<input type="hidden" name="order_id" value="<?php echo (isset($data['order_id']) && ($data['order_id'] !== '')?$data['order_id']:''); ?>">
                                    <input type="hidden" name="user_id" value="<?php echo (isset($data['user_id']) && ($data['user_id'] !== '')?$data['user_id']:''); ?>">
                                    <input type="hidden" name="order_sn" value="<?php echo (isset($data['order_sn']) && ($data['order_sn'] !== '')?$data['order_sn']:''); ?>">
                                    <input type="hidden" name="account" value="<?php echo (isset($data['account']) && ($data['account'] !== '')?$data['account']:''); ?>">
