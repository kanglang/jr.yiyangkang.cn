<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/pig/change.html";i:1554712283;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal" name="position" id="position" method="post" action="<?php echo U('shop/Pig/change_edit'); ?>">
                    <input type="hidden" name="id" value="<?php echo $exclusive_pig['id']; ?>">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">填写会员ID：</label>
                            <div class="input-group col-sm-4">
                                <input id="name" type="text" class="form-control" name="appoint_user_id" value="<?php echo $exclusive_pig['appoint_user_id']; ?>">
                            </div>
                        </div>
