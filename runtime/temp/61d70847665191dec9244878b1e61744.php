<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:77:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/index.html";i:1554712286;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<script>
    ...
    function ajax_get_table(tab,page){
        cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/shop/user/ajaxindex/p/"+page,//+tab,
    ...
    function send_message(id)
    {
        ...
        var url = "<?php echo U('shop/User/sendMessage'); ?>";
        if(obj.is(":checked")){
            var check_val = [];
            for(var k in obj){
                if(obj[k].checked)
    ...
    {
        var obj = $("input[name*='selected']");
        var url = "<?php echo U('shop/User/sendMail'); ?>";
        if(obj.is(":checked")){
            var check_val = [];
            for(var k in obj){
                if(obj[k].checked)
    ...
    function change_leader(id){
        var url = "<?php echo Url('User/change_leader'); ?>"+"?id="+id;
        layer.open({
            type: 2,
            title: '上级用户更改',
            shadeClose: true,
