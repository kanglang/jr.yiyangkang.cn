<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:85:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/change_leader.html";i:1554712287;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrapper wrapper-content animated fadeInRight">
                            ...
                            <form action="" id="search-form2" class="navbar-form form-inline" method="get">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="mobile" value="<?php echo $condition['mobile']; ?>" placeholder="手机号码" id="input-mobile" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="nickname" value="<?php echo $condition['nickname']; ?>" placeholder="会员昵称" class="form-control">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="user_id" value="<?php echo $condition['user_id']; ?>" placeholder="用户ID" class="form-control">
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <form method="post" enctype="multipart/form-data" target="_blank" id="form-order">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <tr onclick="change(<?php echo $list['user_id']; ?>,'<?php echo $list['nickname']; ?>')">
    ...
    <div class="container-fluid">
        <form action=""  class="navbar-form form-inline" method="post">
            <div class="form-group">
                <label class="control-label">选中的用户是：</label>
                <div class="input-group">
                    <input type="hidden" name="id" value="<?php echo $condition['id']; ?>">
                    <input type="hidden" name="user_id" id="user" value=""  class="form-control">
                    <input readonly type="text" id="username" value=""  class="form-control">
                </div>
            </div>
            <div class="form-group">
