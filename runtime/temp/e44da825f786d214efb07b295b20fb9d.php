<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/AppealList.html";i:1554712286;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <div class="container-fluid">
      <div class="ibox float-e-margins">
		...
		<div class="navbar navbar-default">                    
                <form id="search-form2" class="navbar-form form-inline"  method="get" action="<?php echo url('AppealList'); ?>">
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td class="text-center"><img src="<?php echo $v['img_url']; ?>" width="50px" height="50px"></td>
                                    <td class="text-center">
                                          <?php switch($v['status']): case "-1": ?>申诉不通过<?php break; case "0": ?>待申诉<?php break; case "1": ?>申诉通过<?php break; case "2": ?>申诉失效<?php break; endswitch; ?>
                                    </td>
                                      <td align="center" class="handle">
                                          <div style="text-align: center; ">
                                                    <a href="<?php echo url('CheckAppeal',array('id'=>$v['id'],'order_id'=>$v['order_id'])); ?>" class="btn btn-primary"><i class="fa fa-pencil"></i>审核</a>
                                                </div>
                                      </td>
                                </tr>
