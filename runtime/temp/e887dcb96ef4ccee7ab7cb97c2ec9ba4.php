<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:82:"/www/wwwroot/pig.77cco.com/public/../application/admin/view/article/edit_cate.html";i:1554712249;s:68:"/www/wwwroot/pig.77cco.com/application/admin/view/public/header.html";i:1554712249;s:45:"../application/common/view/public/header.html";i:1554712305;s:68:"/www/wwwroot/pig.77cco.com/application/admin/view/public/footer.html";i:1554712249;s:45:"../application/common/view/public/footer.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
                    ...
                    <input type="hidden" name="id" value="<?php echo $cate['id']; ?>">
                        ...
                        <div class="form-group">
                            ...
                            <div class="controls uploadrow2" data-max="1" title="点击修改图片" rel="p_cover">
                                    <input type="hidden" name="cover_url" id="cover_id_p_cover" data-callback="uploadImgCallback" value="<?php echo $cate['cover_url']; ?>"/>
                                    <div class="upload-img-box" rel="img">
                                      <div class="upload-pre-item2">
                                            <img width="100" height="100" src="<?php echo $cate['cover_url']; ?>"/>
                                                                                          </div>
