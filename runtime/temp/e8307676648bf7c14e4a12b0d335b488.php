<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/pig/pigOrder.html";i:1554712282;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="navbar navbar-default">
                            <form action="<?php echo U('shop/order/export_order'); ?>" id="search-form2" class="navbar-form form-inline" method="post">
...
<script>
    ...
    function order_pig(id){
        ...
        var url = "<?php echo Url('Pig/order_pig'); ?>"+"?id="+id;
        layer.open({
            type: 2,
            title: '修改订单结束时间',
            shadeClose: true,
