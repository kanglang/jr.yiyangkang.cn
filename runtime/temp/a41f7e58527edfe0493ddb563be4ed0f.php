<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/goods/goodsList.html";i:1554712288;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="ibox-content">
          <div class="navbar navbar-default">
              <form action="" id="search-form2" class="navbar-form form-inline" method="post" onsubmit="return false">
                ...
                <button type="button" onclick="location.href='<?php echo U('shop/goods/addEditGoods'); ?>'" class="btn btn-primary pull-right"><i class="fa fa-plus"></i>添加新商品</button>
              </form>
          </div>
...
<script>
    ...
    function ajax_get_table(form,page){
		cur_page = page; //当前页面 保存为全局变量
            $.ajax({
                type : "POST",
                url:"/index.php/shop/goods/ajaxGoodsList?p="+page,//+tab,
        ...
        function del(id)
        {
            if(!confirm('确定要删除吗?'))
                return false;
		$.ajax({
			url:"/index.php/shop/goods/delGoods?id="+id,
			success: function(v){	
                                var v =  eval('('+v+')');                                 
