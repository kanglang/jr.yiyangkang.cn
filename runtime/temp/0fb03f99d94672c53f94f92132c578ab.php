<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:86:"/www/wwwroot/jr.yiyangkang.cn/public/../application/shop/view/user/Check_identity.html";i:1554712286;s:70:"/www/wwwroot/jr.yiyangkang.cn/application/shop/view/public/header.html";i:1554712283;s:45:"../application/common/view/public/header.html";i:1554712305;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
        ...
        <div class="container-fluid">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="panel-body ">   
                    <!--表单数据-->
                    <form method="post" id="position" action="<?php echo U('shop/User/Check_identity_edit'); ?>">                    
                        <!--通用信息-->
                        ...
                        <div class="tab-pane active" id="tab_tongyong">                           
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    <td>真实名字：</td>
                                    <td>
                                        <?php echo $list['real_name']; ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td>身份证号码：</td>
                                    <td>
                                        <?php echo $list['identity']; ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>审核状态：</td>
                                    <td>
                                        <select class="form-control m-b chosen-select" name="status" <?php if($list['status'] == 1): ?>disabled<?php endif; if($list['status'] == -1): ?>disabled<?php endif; ?>>
                                            <!-- <option value="">==请操作审核==</option> -->
                                            <option <?php if(@$list['status'] == -1): ?>selected<?php endif; ?> value="-1">审核不通过</option>
                                            <option <?php if(@$list['status'] == 0): ?>selected<?php endif; ?> value="0">待审核</option>
                                            <option <?php if(@$list['status'] == 1): ?>selected<?php endif; ?> value="1">审核通过</option>
                                        </select>
                                        <td class="col-sm-4">确认好身份及提交审核</td>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>审核不通过的原因：</td>
                                    <td>
                                        <textarea rows="5" cols="30" name="reason"><?php echo (isset($send_mail) && ($send_mail !== '')?$send_mail:''); ?></textarea>
                                    </td>
                                    <td class="col-sm-4">审核通过不用填写</td>
                                </tr>
