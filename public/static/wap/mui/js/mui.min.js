...
if (!flag) {
	...
	var href = this.href;
	var type = this.getAttribute("open-type")?this.getAttribute("open-type"):'common';
...
//点击事件失效点击。。。
mui('.mui-scroll').on('tap', 'div', function(e) {
	...
	if(id){
		...
		e.stopPropagation();//阻止事件冒泡2016/11/4
	}
	//e.stopPropagation();
});
//////////////////////////////////////////////