...
function AjaxAddCart(goods_id,num,to_catr)
{
    ...
    if($("#buy_goods_form").length > 0){
        $.ajax({
            type : "POST",
            url:"/index.php/Mobile/Cart/ajaxAddCart",
            ...
            success: function(data){
			   ...
			   if(to_catr == 1)  //直接购买
			   {
				   location.href = "/index.php/Mobile/Cart/index";
			   }
        ...
        $.ajax({
            ...
            success: function(data){
				   ...
				   {
					    //layer.open({content: data.msg,time: 2});
						location.href = "/index.php/Mobile/Goods/goodsInfo?id="+goods_id;
				   }
				   else
				   {
					    if(data.status < 0)
...
function collect_goods(goods_id){
	$.ajax({
		type : "GET",
		dataType: "json",
		url:"/index.php/Mobile/goods/collect_goods?goods_id="+goods_id,//+tab,
		success: function(data){
			alert(data.msg);
		}
	});
