...
function AjaxAddCart(goods_id,num,to_catr)
{
        ...
        if($("#buy_goods_form").length > 0){
                $.ajax({
                        type : "POST",
                        url:"/index.php/Home/Cart/ajaxAddCart",
                        ...
                        success: function(data){	
							   ...
							   if(to_catr == 1)  //直接购买
							   {
								   location.href = "/index.php/Home/Cart/cart";   
							   }
							   else
							   {
									...
									layer.open({
										  ...
										  area: ['490px', '386px'], //宽高
                                          content:["/index.php/Home/Goods/open_add_cart","no"],
                ...
                $.ajax({
                        ...
                        success: function(data){
							   if(data.status == -1)
							   {
									location.href = "/index.php/Home/Goods/goodsInfo?id="+goods_id;   
							   }
							   else
							   {
								    // 加入购物车有误
									...
									layer.open({
										  ...
										  skin: 'layui-layer-rim', //加上边框
										  area: ['490px', '386px'], //宽高
										  content:"/index.php/Home/Goods/open_add_cart"
									});							   
							   }							   							   
                        }
                });            
...
function collect_goods(goods_id){
	$.ajax({
		type : "GET",
		dataType: "json",
		url:"/index.php?m=Mobile&c=Goods/collect_Goods?goods_id="+goods_id,//+tab,
		success: function(data){
			alert(data.msg);
		}
	});
