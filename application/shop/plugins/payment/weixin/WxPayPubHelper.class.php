...
class Common_util_pub 
{
	...
	function __construct($payment_info = array()) {
		...
		//初始支付配置信息
		$this->appid 	 = $payment_info['appid'];
		$this->mchid 	 = $payment_info['mchid'];
		$this->key  	 = $payment_info['key'];
		$this->appsecret = $payment_info['appsecret'];
	}
	...
	{  
		...
		//$String = $String."&key=E963DFSPL3DA6DANBWIUMD9EKDMAALW4"; 
...
{	
	function __construct($payment_info = array()) 
	{
		Common_util_pub::__construct($payment_info);
	...
	function getPrepayId()
	{
		$this->postXml();
		$this->result = $this->xmlToArray($this->response);
		//file_put_contents('./weipay.log',var_export($this->result,true),LOCK_EX);
